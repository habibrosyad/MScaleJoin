...
public class ScaleGateTest {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        PRODUCERS = 4;
        CONSUMERS = 4;
        ScaleGateTest theTest = new ScaleGateTest();
    ...
    class Consume implements Runnable {
        ...
        public void run() {
            ...
            ScaleGateTuple cur, prev;
            do {
                prev = tgate.getNextReadyTuple(id);
            } while (prev == null);

            long sum = prev.getTimestamp();
            while (true) {
                ...
                if (cur != null) {
                    ...
                    if (cur.getTimestamp() >= TEST_SIZE - 1 - PRODUCERS) //last tuple, break
                        break;
                    prev = cur;
                }
            }

            System.out.println("PThread thread " + id + " done " + sum);
        }
    }
}